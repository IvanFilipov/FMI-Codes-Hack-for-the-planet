...
def last():
    servoController.moveServo(7,90)
    servoController.moveServo(5,0)
    servoController.moveServo(6,90)
    # moveServo(4,180)
    # verticaleMove(120)
    servoController.ifLessThenMoveTo(0, 120, 120)
    # moveServo(2,90)
    servoController.ifGreatThenMoveTo(2, 90, 90)
    servoController.verticaleMove(180)
    servoController.moveServo(2,0)
    servoController.moveServo(4,90)
